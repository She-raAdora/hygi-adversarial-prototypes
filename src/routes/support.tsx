...
const FAQ = [
  {
    ...
    a: "No. All 30 lessons, quizzes, badges, and the trophy are free and open with no sign-in. Accounts exist only for staff who need the admin and Insights pages.",
  },
  {
